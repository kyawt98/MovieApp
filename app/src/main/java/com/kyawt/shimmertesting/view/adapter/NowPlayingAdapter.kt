...
class NowPlayingAdapter(var nowPlayingList: List<MovieResult> = emptyList()) :
    RecyclerView.Adapter<NowPlayingViewHolder>() {
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): NowPlayingViewHolder {
        return NowPlayingViewHolder(parent.context.viewBinding(R.layout.item_movie, parent))
    }
